...
<{if $chess_rating_system != 'none'}>
	...
	<table>
		...
		<{if isset($chess_player.rating)}>
			...
			<tr class="head">
				<td class="head" width='33%'><{$smarty.const._MD_CHESS_WON|capitalize}></th>
				<td class="head" width='34%'><{$smarty.const._MD_CHESS_LOST|capitalize}></th>
				<td class="head" width='33%'><{$smarty.const._MD_CHESS_DRAWN|capitalize}></th>
			</tr>
