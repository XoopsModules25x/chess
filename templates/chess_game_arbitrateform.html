...
<{if $chess_gamedata.suspended}>
	...
	<tr>
		<td class="odd" style="text-align:left">
			<{$smarty.const._MD_CHESS_WHEN_SUSPENDED}>:
		</td>
		<td class="odd" style="text-align:left">
			<{$smarty.const._DATESTRING|date:$chess_suspend_info.date}>
		</td>
	</tr>

	<tr>
		<td class="odd" style="text-align:left">
			<{$smarty.const._MD_CHESS_SUSPENDED_BY}>:
		</td>
		<td class="odd" style="text-align:left">
			<{$chess_suspend_info.user}>
		</td>
	</tr>

	<tr>
		<td class="odd" style="text-align:left">
			<{$smarty.const._MD_CHESS_SUSPENSION_TYPE}>:
		</td>
		<td class="odd" style="text-align:left">
			<{$chess_suspend_info.type}>
		</td>
	</tr>

	<tr>
		<td class="odd" style="text-align:left">
			<{$smarty.const._MD_CHESS_SUSPENSION_REASON}>:
		</td>
		<td class="odd" style="text-align:left">
			<{$chess_suspend_info.reason}>
		</td>
	</tr>
