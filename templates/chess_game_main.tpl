...
<{* #*#TBD# - color of player names in th-tag not visible enough in some themes, e.g. default theme, since they're in a-tags. *}>
		<th style="text-align:center" colspan="2"><a href="<{$smarty.const.XOOPS_URL}>/modules/chess/player_stats.php?player_uid=<{$chess_gamedata.white_uid}>"><font size="+1"><b><{$chess_white_user|replace:' ':'&nbsp;'}></b></font></a>&nbsp;<{$smarty.const._MD_CHESS_LABEL_VS}>&nbsp;<a href="<{$smarty.const.XOOPS_URL}>/modules/chess/player_stats.php?player_uid=<{$chess_gamedata.black_uid}>"><font size="+1"><b><{$chess_black_user|replace:' ':'&nbsp;'}></b></font></a></th>
	...
	<td style="text-align:center">
		...
		<{if $can_move}>
			...
			<noscript>
				...
				<table>
				<tr>
					<td><div class="errorMsg"><{$smarty.const._MD_CHESS_NO_JAVASCRIPT}></div></td>
				</tr>
				</table>
			</noscript>
